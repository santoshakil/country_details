List<CountryDetailsModel> get countryDetails {
  List<Map> map = countryData;
...
class StateNames {
  ...
  factory StateNames.fromJson(Map<String, String> json) => StateNames(
...
const List<Map<String, Object>> countryData = [
  {
